...
!function(exports) {
            ...
            if (mappings && mappings.length > 0) {
              ...
              for (var ii = mappings.length - 1; ii >= 0; ii--) {
                ...
                tagbody = tagbody.replace(this.attr, function(str, key, value, a) {
                  ...
                  if (shouldSetAttribute && mappings[ii].insert !== key) {
                    return str;
                  }
                  ...
                  else if (!mappings[ii].insert && mappings[ii].attribute === key) {
  ...
  function last(newitem) {
    ...
    if (m.attribute && m.value && m.dataKey && m.insert) {
  ...
  Mapper.prototype = {
    ...
    insert: function(val) {
      ...
      l.insert = l.attribute;
      l.dataKey = val;
      return last.call(this) && this;
    },
    as: function(val) {
      last.call(this).insert = val;
      return last.call(this) && this;
    }
  };
